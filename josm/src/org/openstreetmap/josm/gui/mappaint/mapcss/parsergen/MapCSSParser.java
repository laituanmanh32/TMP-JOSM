 ...
 */
  final public void pp_black_box(boolean write) throws ParseException {
    Token t;
    label_1:
    while (true) {
 ...
 */
  final public void pp_supports(boolean ignore) throws ParseException {
    boolean pass;
 ...
 */
  final public boolean pp_supports_condition() throws ParseException {
    boolean pass;
    boolean q;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PP_NOT:
 ...
 * @return true, if the condition is fulfilled
 */
  final public boolean pp_supports_condition_in_parens() throws ParseException {
    boolean pass;
 ...
 * @return true if the condition is fulfilled
 */
  final public boolean pp_supports_declaration_condition() throws ParseException {
    Token t;
    String feature;
    Object val = null;
    jj_consume_token(LPAR);
    ...
    jj_consume_token(RPAR);
      {if (true) return this.sheet.evalSupportsDeclCondition(feature, val);}
    throw new Error("Missing return statement in function");
  }

// deprecated
  final public void pp_media(boolean ignore) throws ParseException {
    boolean pass = false;
    boolean q;
    boolean empty = true;
...
// deprecated
  final public boolean pp_media_query() throws ParseException {
    Token t;
    ...
    default:
      ...
      throw new ParseException();
        ...
        {if (true) return invert ? (!pass) : pass;}
    throw new Error("Missing return statement in function");
  }
 ...
 */
// deprecated
  final public boolean pp_media_expression() throws ParseException {
    Token t;
    String feature;
    Object val = null;
    jj_consume_token(LPAR);
  ...
  final public void pp_w1() throws ParseException {
    Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PP_NEWLINECHAR:
 ...
 */
  ...
  final public Selector child_selector() throws ParseException {
    ...
    default:
      ...
      {if (true) return selRight != null ? new ChildOrParentSelector(selLeft, selLink, selRight, type) : selLeft;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Condition condition(Context context) throws ParseException {
    ...
    if (jj_2_5(2147483647)) {
      ...
      case MINUS:
        e = expression();
        jj_consume_token(RSQUARE);
                                       {if (true) return Condition.createExpressionCondition(e, context);}
        break;
      default:
        jj_la1[43] = jj_gen;
        jj_consume_token(-1);
  ...
  final public Condition simple_key_condition(Context context) throws ParseException {
    ...
    default:
      ...
      {if (true) return Condition.createKeyCondition(key, not, matchType, context);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Condition simple_key_value_condition(Context context) throws ParseException {
    ...
    if (jj_2_9(3)) {
      ...
      {if (true) return Condition.createKeyValueCondition(key, val, op, context, considerValAsKey);}
    throw new Error("Missing return statement in function");
  }

  final public Condition class_or_pseudoclass(Context context) throws ParseException {
    String s;
    boolean not = false;
    boolean pseudo;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public Subpart subpart() throws ParseException {
    String s;
    Expression e;
    ...
    case IDENT:
      s = ident();
                    {if (true) return new Subpart.StringSubpart(s);}
      break;
    case STAR:
      jj_consume_token(STAR);
                 {if (true) return new Subpart.StringSubpart("*");}
      break;
    case LPAR:
      jj_consume_token(LPAR);
      e = expression();
      jj_consume_token(RPAR);
                                       {if (true) return new Subpart.ExpressionSubpart(e);}
      break;
    default:
      jj_la1[58] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Declaration declaration() throws ParseException {
    ...
    while (true) {
      ...
      case SET:
        ...
        case RBRACE:
          jj_consume_token(RBRACE);
                         {if (true) return new Declaration(ins, declarationCounter++);}
          break;
        case SEMICOLON:
 ...
 */
  ...
  final public Expression conditional_expression() throws ParseException {
    Expression e, e1, e2;
    String op = null;
    e = or_expression();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public Expression relational_expression() throws ParseException {
    Expression e, e2;
    String op = null;
  ...
  final public Expression unary_expression() throws ParseException {
    ...
    w();
        if (op == null)
            {if (true) return e;}
        {if (true) return ExpressionFactory.createFunctionExpression(op, Collections.singletonList(e));}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Expression primary() throws ParseException {
    ...
    if (jj_2_12(3)) {
      ...
      case PLUS:
        lit = literal();
            if (lit == null)
                {if (true) return NullExpression.INSTANCE;}
  ...
  final public Expression function() throws ParseException {
    ...
    jj_consume_token(RPAR);
      {if (true) return ExpressionFactory.createFunctionExpression(name, args);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Object literal() throws ParseException {
    ...
    if (jj_2_13(2)) {
      ...
      t = jj_consume_token(HEXCOLOR);
          {if (true) return Main.pref.getColor("mappaint." + (sheet == null ? "MapCSS" : sheet.title) + "." + pref, ColorHelper.html2color(t.image));}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case IDENT:
        t = jj_consume_token(IDENT);
      ...
      default:
        ...
        if (jj_2_14(2)) {
          ...
          case HEXCOLOR:
            t = jj_consume_token(HEXCOLOR);
                       {if (true) return ColorHelper.html2color(t.image);}
            break;
          default:
            jj_la1[82] = jj_gen;
            jj_consume_token(-1);
 ...
 */
  final public Float ufloat_unit() throws ParseException {
    float f;
    String u;
    f = ufloat();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      throw new ParseException();
        ...
        if (m == null)
            {if (true) return null;}
        {if (true) return (float) (f * m);}
    throw new Error("Missing return statement in function");
  }

  private Double unit_factor(String unit) throws ParseException {
    switch (unit) {
        case "deg":
